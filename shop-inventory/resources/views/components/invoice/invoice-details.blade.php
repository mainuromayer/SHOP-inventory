    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn text-white" data-bs-dismiss="modal" style="background-image: linear-gradient(to top, rgb(0, 34, 141), rgb(37, 93, 157))">Close</button>
                <button onclick="PrintPage()" class="btn text-white" style="background-image: linear-gradient(to top, rgb(44, 141, 0), rgb(41, 157, 37));">Print</button>
            </div>
        </div>
    </div>
</div>
